...
public class RendezVous {
    ...
    public RendezVous(Creneau creneau, Patient patient, LocalDate date) { this.creneau = creneau;
        this.patient = patient; this.date = date;
    }
    public void afficher() {
        ...
        System.out.printf("avec le Dr %s%npour ",
                this.creneau.getMedecinGeneraliste().getNom());
